...
from nets.fastseg import MobileV3Small, MobileV3Large
from nets.fastseg_training import (get_lr_scheduler, set_optimizer_lr,
                                     weights_init)
...
if __name__ == "__main__":
    ...
    large_backbone        = True
    #---------------------------------#
    #   所使用的的主干网络(这是没有的，我没有上传预训练网络，自己从头开始训练吧)
    #---------------------------------#
    backbone        = "mobilev3_large"
    #----------------------------------------------------------------------------------------------------------------------------#
